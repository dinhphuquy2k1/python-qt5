...
"")
        ...
        self.tableUser = QtWidgets.QTableWidget(self.frame)
        ...
        self.tableUser.horizontalHeader().setDefaultSectionSize(150)
        ...
        self.gridLayout_9.addWidget(self.tableUser, 0, 0, 1, 1)
